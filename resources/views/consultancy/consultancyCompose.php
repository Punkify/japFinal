...
<html lang="en">
  <head>
    ...
    <title>Japanease File Management System</title>
  ...
  <section id="container" >
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>CONSULTENCY NAME</b></a>
            <!--logo end-->
    ...
    color: #fff;">
              <p>ADMINISTRATOR</p>
              <a href="#" style="
    color: #fff;"><i class="fa fa-circle text-success"></i> Online</a>
            </div>
          </div>
                  <li class="mt">
                      <a href="index.html">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="messages.html">
                          <i class="fa fa-envelope-o"></i>
                          <span>Messages</span>
                      </a>
