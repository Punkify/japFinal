...
@section('consultancyContent')
      ...
      <section id="main-content">
          <section class="wrapper">
              ...
              <li class="active"><a href="#lD" data-toggle="tab"> <span class="fa fa-user bg-aqua"></span> STUDENT</a></li>
              </ul>
        ...
        <!-- The consultancy tab starts here -->
          ...
          <button type="button" class="btn btn-info btn-circle btn-lg" data-toggle="modal" data-target="#myModal2"><span class="glyphicon glyphicon-plus"></span></button>
