                ...
                <div class="col-lg-9 main-chart">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="content-panel">
                            <h4><i class="fa fa-angle-right"></i>RECENT CASES</h4><hr><table class="table table-striped table-advance table-hover">


                                <thead>
                                <tr>
                                    <th><i class="fa fa-bullhorn"></i> CASE</th>
                                ...
                                <tbody>
                                <tr>
                                    <td><a href="client.html">Anmol Chalise</a></td>
