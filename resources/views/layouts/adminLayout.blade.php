    ...
    <header class="header black-bg">
        ...
        <div class="top-menu">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li><a class="logout" href="settings.html" data-toggle="tooltip" data-placement="bottom" title="Settings"><i class="fa fa-wrench" aria-hidden="true"></i></a></li>
    ...
    *********************************************************************************************************************************************************** -->
    ...
    color: #fff;">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a  href="client.html#1B">Schools</a></li>
                        <li><a  href="client.html#1C">Consultancies</a></li>
                        <li><a  href="client.html#1D">Students</a></li>
                    </ul>
                </li>
